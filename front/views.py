                ...
                for row in ws.iter_rows(values_only=True):
                    ...
                    if len(data_list) > 1000:
                        ...
                        data_list.append(models.StrainData(
                            ...
                            test_method_1=Decimal(row[1]) if len(row) > 1 else 0.00, 
                            test_method_2=Decimal(row[2]) if len(row) > 2 else 0.00, 
                            test_method_3=Decimal(row[3]) if len(row) > 3 else 0.00, 
                            test_method_4=Decimal(row[4]) if len(row) > 4 else 0.00, 
                            test_method_5=Decimal(row[5]) if len(row) > 5 else 0.00, 
                            test_method_6=Decimal(row[6]) if len(row) > 6 else 0.00, 
                            test_method_7=Decimal(row[7]) if len(row) > 7 else 0.00, 
                            test_method_8=Decimal(row[8]) if len(row) > 8 else 0.00, 
                            test_method_9=Decimal(row[9]) if len(row) > 9 else 0.00, 
                            test_method_10=Decimal(row[10]) if len(row) > 10 else 0.00, 
                            test_method_11=Decimal(row[11]) if len(row) > 11 else 0.00, 
                            test_method_12=Decimal(row[12]) if len(row) > 12 else 0.00, 
                            test_method_13=Decimal(row[13]) if len(row) > 13 else 0.00, 
                            test_method_14=Decimal(row[14]) if len(row) > 14 else 0.00, 
                            test_method_15=Decimal(row[15]) if len(row) > 15 else 0.00, 
                            test_method_16=Decimal(row[16]) if len(row) > 16 else 0.00, 
                            test_method_17=Decimal(row[17]) if len(row) > 17 else 0.00, 
                            test_method_18=Decimal(row[18]) if len(row) > 18 else 0.00, 
                            test_method_19=Decimal(row[19]) if len(row) > 19 else 0.00, 
                            test_method_20=Decimal(row[20]) if len(row) > 20 else 0.00, 
                            test_method_21=Decimal(row[21]) if len(row) > 21 else 0.00, 
                            test_method_22=Decimal(row[22]) if len(row) > 22 else 0.00, 
                            test_method_23=Decimal(row[23]) if len(row) > 23 else 0.00, 
                            test_method_24=Decimal(row[24]) if len(row) > 24 else 0.00, 
                            test_method_25=Decimal(row[25]) if len(row) > 25 else 0.00, 
                            test_method_26=Decimal(row[26]) if len(row) > 26 else 0.00, 
                            test_method_27=Decimal(row[27]) if len(row) > 27 else 0.00, 
                            test_method_28=Decimal(row[28]) if len(row) > 28 else 0.00, 
                            test_method_29=Decimal(row[29]) if len(row) > 29 else 0.00, 
                            test_method_30=Decimal(row[30]) if len(row) > 30 else 0.00, 
                            test_method_31=Decimal(row[31]) if len(row) > 31 else 0.00, 
                            test_method_32=Decimal(row[32]) if len(row) > 32 else 0.00, 
                            test_method_33=Decimal(row[33]) if len(row) > 33 else 0.00, 
                            test_method_34=Decimal(row[34]) if len(row) > 34 else 0.00, 
                            test_method_35=Decimal(row[35]) if len(row) > 35 else 0.00, 
                            test_method_36=Decimal(row[36]) if len(row) > 36 else 0.00, 
                            test_method_37=Decimal(row[37]) if len(row) > 37 else 0.00, 
                            test_method_38=Decimal(row[38]) if len(row) > 38 else 0.00, 
                            test_method_39=Decimal(row[39]) if len(row) > 39 else 0.00, 
                            test_method_40=Decimal(row[40]) if len(row) > 40 else 0.00, 
                            test_method_41=Decimal(row[41]) if len(row) > 41 else 0.00, 
                            test_method_42=Decimal(row[42]) if len(row) > 42 else 0.00
                        ))
                    else:
                        data_list.append(models.StrainData(
                            date_time=datetime.strptime(row[0], "%d-%m-%Y %H:%M:%S"), 
